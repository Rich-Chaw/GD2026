...
class GraphDQN:
    ...
    def __init__(self):
        ...
        self.g_type =  'barabasi_albert'#'barabasi_albert', 'small-world',"erdos_renyi","powerlaw","ego"
...
#################################################New code for graphDQN#####################################
    def BuildNet(self):
        ...
        while lv < max_bp_iter:
            ...
            n2npool = tf.compat.v1.compat.v1.sparse_tensor_dense_matmul(tf.cast(self.n2nsum_param,tf.float32), cur_message_layer)
            ...
            y_n2npool = tf.compat.v1.compat.v1.sparse_tensor_dense_matmul(tf.cast(self.subgsum_param,tf.float32), cur_message_layer)
